						    ...
						    <tbody>
							   <c:forEach items="${leaves}" var="value">
							       <tr class="text-center">
										...
										<td ><a href="/Reject?reqid=${value.id}"><i class="fa fa-close" style="font-size:30px;color:red"></i></a></td>
										<td ><a href="/Approve?reqid=${value.id}"><i class="fa fa-check" style="font-size:30px;"></i></a></td>
									</tr>
								</c:forEach>
